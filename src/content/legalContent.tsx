...
export const privacyPolicy: LegalDocument = {
  ...
  sections: [
    ...
    { id: "providers", title: "Services that help run the website", content: <>
      <p>We use Google Firebase/Firestore for website records and Cloudflare R2 for uploaded files. The website and its backend run on Google Cloud infrastructure in Council Bluffs, Iowa, United States. These providers process information needed to supply storage, delivery, security, and operational support. Database, file-storage, and backup locations depend on their separate service configurations.</p>
    ...
    { id: "retention", title: "Storage, retention, and security", content: <>
      ...
      <p>Console logs retained by our website host are kept for 30 days. Depending on the logging configuration, these may include application errors and access logs containing connection information. This period applies to the host’s console logs; backups and other service-provider records follow their separate retention settings.</p>
      <p>We use access restrictions, encrypted transport in production, and encrypted server-side session storage to protect information. No online service can promise complete security.</p>
    </> },
